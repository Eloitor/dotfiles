--[[
	Theme Copland-Eloi
     ...
     Based on Copland Awesome WM theme 2.0
     github.com/lcpz
...
-- Own: We define an icon theme
theme.icon_theme = "Adwaita" -- "gnome" -- "Adwaita"
-- end own
...
--{{{
 -- create a network menu widget
    ...
    mynetworklauncher =   awful.widget.launcher({
	   -- image = beautiful.network_icon,
	   --  image = beautiful.awesome_icon,
	   image = "/usr/share/icons/Adwaita/8x8/places/folder-documents.png",
     menu = awful.menu({ items = { { "s" , "s" }, { "s" , "s" }, } }) })
...
theme.weather = lain.widget.weather({
    city_id = 3108286, --Terrassa

    	--2643743, -- placeholder (London)
})
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            small_spr,
            --theme.mail.widget,
	    awful.widget.watch('bash -c "xkb-switch"', 10),
	    -- TODO make keyboard clikable
            mpdicon,
            theme.mpd.widget,
            baticon,
            batwidget,
